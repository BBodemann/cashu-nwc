...
var NPCPlugin = class {
	...
	*/
	constructor(baseUrl, signer, options) {
		...
		this.npcClient = new NPCClient(baseUrl, new JWTAuthProvider(baseUrl, signer, npcLogger));
	}
	/**
...
//#endregion
export { LocalStorageSinceStore, MemorySinceStore, NPCPlugin, PluginApi, QUOTE_DEFAULTS, createChildLogger, formatLogMessage, isValidQuote, isValidUrl };