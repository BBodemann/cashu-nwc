	...
	},
	{
		...
		run: async (db) => {
			...
			for (const { mintUrl } of mints) {
				const normalized = (0, coco_cashu_core.normalizeMintUrl)(mintUrl);
...
exports.SqliteCounterRepository = SqliteCounterRepository;
exports.SqliteDb = SqliteDb;
exports.SqliteHistoryRepository = SqliteHistoryRepository;
exports.SqliteKeyRingRepository = SqliteKeyRingRepository;
exports.SqliteKeysetRepository = SqliteKeysetRepository;
exports.SqliteMeltOperationRepository = SqliteMeltOperationRepository;
exports.SqliteMeltQuoteRepository = SqliteMeltQuoteRepository;
exports.SqliteMintQuoteRepository = SqliteMintQuoteRepository;
exports.SqliteMintRepository = SqliteMintRepository;
exports.SqliteProofRepository = SqliteProofRepository;
exports.SqliteRepositories = SqliteRepositories;
exports.SqliteSendOperationRepository = SqliteSendOperationRepository;
exports.ensureSchema = ensureSchema;
exports.ensureSchemaUpTo = ensureSchemaUpTo;